...
b.removeErrorMessage=function(a){b.getErrorMessageElement(a).textContent="";return b};b.getErrorMessageElement=function(a){var b=document.querySelector('[data-form-submit-error-for="'+(a.getAttribute("data-form-submit-group")||a.id||a.name)+'"]');if(!b){b=document.createElement("span");b.className="form-submit-error";b.setAttribute("data-form-submit-error-for",a.getAttribute("data-form-submit-group")||a.id||a.name);if("radio"==a.type.toLowerCase()){var e=a.form.querySelectorAll('[name="'+a.name+'"]');
e=e[e.length-1].nextElementSibling}else e=a.nextElementSibling;a.parentElement.insertBefore(b,e)}return b};b.addCounter=function(a,c){r(a,b.addCounterSingleElement,c);return b};b.addCounterSingleElement=function(a,c){b.removeCounterSingleElement(a);void 0!==c?a.setAttribute("data-form-submit-count",c):isNaN(parseInt(a.getAttribute("data-form-submit-count")))&&a.setAttribute("data-form-submit-count",a.getAttribute("maxlength"));a.addEventListener("input",k);a.addEventListener("keypress",k);a.addEventListener("change",
k);a.addEventListener("blur",k);k({currentTarget:a});return b};b.removeCounter=function(a){r(a,b.removeCounterSingleElement);return b};b.removeCounterSingleElement=function(a){a.removeEventListener("input",k);a.removeEventListener("keypress",k);a.removeEventListener("change",k);a.removeEventListener("blur",k);b.getCounterElement(a).textContent="";return b};b.getCounterElement=function(a){var b=document.querySelector('[data-form-submit-counter-for="'+(a.getAttribute("data-form-submit-group")||a.id||
a.name)+'"]');b||(b=document.createElement("span"),b.className="form-submit-counter",b.setAttribute("data-form-submit-counter-for",a.id||a.name),a.parentElement.insertBefore(b,a.nextSibling));return b};b.unload=function(){var a,c,e=document.querySelectorAll("data-form-submit-count");for(c in m)b.removeValidation(m[c]);for(c=0;a=e[c];c++)b.removeCounter(a);return b};b.validation=new function(){var a=this;a.isDigits=function(a){return 0<=a.search(/^\d+$/)};a.isNumber=function(a){return 0<=a.search(/^\-?((\d{1,3}(,?\d{3})*)\.?\d*|(\d{1,3}(,?\d{3})*)?\.\d+)$/)};
...
(d.M=d.H.slice(1)+d.M,d.H=d.H.slice(0,1));d.M&&(d.S=d.S||"0");d.S&&(d.MS=((d.MS||"")+"000000").slice(0,6));["m","d","H","M","S"].forEach(function(a){var b=d[a];b&&(d[a]=b.match(/^0*(\d+)$/)[1],d[a+a]=("0"+b).slice(-2))});d.yy&&(4==d.yy.length?(d.yyyy=d.yy,d.yy=d.yy.slice(-2)):d.yyyy=50>d.yy?"20"+d.yy:"19"+d.yy);d.H&&(g=parseInt(d.H)%12,(c=a.match(/(a|p)/i))?("p"==c[1]&&(g=(g+12)%24),d.H24=g.toString(),d.HH24=("0"+d.H24).slice(-2)):(d.H24=d.H,d.HH24=d.HH,d.H=g.toString(),d.HH=("0"+d.H).slice(-2)));
return b.replace(/mm|m|dd|d|yyyy|yy|HH24|H24|HH|H|MS|MM|M|SS|S/g,function(a,b){if(d[a])return d[a];void 0===f&&(f=b);return""}).slice(0,f)||a};a.formatDate=function(b,c){return a.formatTimestamp(b,c||"mm/dd/yyyy")};a.formatTime=function(b,c){return a.formatTimestamp(b,c||"HH24:MM")};var b=function(a){a=a.match(/^([^\.]*)(\.?)([^\.]*)$/).slice(1);a[0]=a[0].replace(/\B(?=(?:\d{3})+\b)/g,",");return a.join("")},e=function(a,b,c){var d="",e="",f,g;if(c&&(f=a.match(/mm|m|dd|d|yyyy|yy|HH24|H24|HH|H|MS|MM|M|SS|S/g)))for(d=
"(?:",c=0;c<f.length;c++)e+=")?";return new RegExp("^\\D*"+a.replace(/mm|m|dd|d|yyyy|yy|HH24|H24|HH|H|MS|MM|M|SS|S|.+?/g,function(a){return(g=A[a])?d+g:b?"\\D?":a.replace(/(\W)/g,"\\$1")})+e+"\\D*$")}};var r=function(a,b){var c=Array.prototype.slice.call(arguments,2);"string"===typeof a?a=document.querySelectorAll(a):a.nodeType&&(a=[a]);for(var f=0,g;g=a[f];f++)b.apply(null,[g].concat(c))},q=function(a){var b=parseInt(a.getAttribute("data-form-submit-id"));isNaN(b)&&a.setAttribute("data-form-submit-id",
b=z++);return b},w=function(a){var c=a.currentTarget.querySelectorAll("[name]"),e=!0,f=a.currentTarget.getAttribute("data-form-submit-always-allow");if(f&&"false"!=f.toLowerCase())return!0;for(var g,n=0;f=c[n];n++)if(g=b.getErrorMessage(f))b.displayErrorMessage(f,g),e&&(e=!1,f.focus());e||a.preventDefault();return e},t=function(a){var c;(c=b.getErrorMessage(a.currentTarget))?b.displayErrorMessage(a.currentTarget,c):b.removeErrorMessage(a.currentTarget)},k=function(a){var c=b.getCounterElement(a.currentTarget),
e=a.currentTarget.getAttribute("data-form-submit-count");a.currentTarget.value=a.currentTarget.value.slice(0,parseInt(e));c.textContent=a.currentTarget.value.length+"/"+e},p=function(a){return a.getAttribute("data-form-submit-error-msg")||"Invalid input"},h=function(a,c,e,f){b.addValidationSingleElement(a,function(a,b){return c(b.value=e(a,f),f)?"":p(b)})},l=function(a,c,e,f){b.addValidationSingleElement(a,function(a,b){return!c(b.value=e(a,f),f)&&b.value.length?p(b):""})},x=function(a,b){null===
a.getAttribute("placeholder")&&a.setAttribute("placeholder",b)},y=function(a){var c,e,f,g;a=document.querySelectorAll("[data-form-submit-required]");for(e=0;c=a[e];e++)if(f=c.getAttribute("data-form-submit-required"))switch(f=String(f).toLowerCase(),(g=v[f])&&x(c,g),f){case "digits":h(c,b.validation.isDigits,b.validation.formatDigits);break;case "number":h(c,b.validation.isNumber,b.validation.formatNumber);break;case "currency":h(c,b.validation.isCurrency,b.validation.formatCurrency);break;case "phone":h(c,
